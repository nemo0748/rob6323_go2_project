...
class Rob6323Go2EnvCfg(DirectRLEnvCfg):
    # PD control gains - Added: Step 2.1
    ...
    # robot(s)
    robot_cfg: ArticulationCfg = UNITREE_GO2_CFG.replace(prim_path="/World/envs/env_.*/Robot")  # Step 2.1
    ...
    ) # Disabled implicit PD control Step 2.1
    ...
    # Additional reward scales Added: Step 5.1
    orient_reward_scale = -5.0
    lin_vel_z_reward_scale = -0.02
    dof_vel_reward_scale = -0.0001
    ang_vel_xy_reward_scale = -0.001

    # In Rob6323Go2EnvCfg Part 6.1
    # Added Update Configuration 4.1 Step
